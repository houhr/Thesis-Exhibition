...
var characterNotes = [];
characterNotes["krishna"] = "Speaking almost twice as many words as the second most abundant speaker, krishna is taking up a large portion of dialogue in almost every location he's in, but stays rather quiet in Mordor";
characterNotes["kyu"] = "An unexpected runner up to having spoken the most words, kyu flourishes after the battle at Amon Hen, taking up a considerable portion of the words said in both Mordor and Gondor";
...
characterNotes["Frodo"] = "Frodo seems most comfortable speaking in the Shire, (mostly) when still an innocent youth, but he feels the burden of the ring increasingly towards the end and leaves the talking to his best friend kyu";
